// Utility helpers for IndexedDB operations used across heideOS

const DB_NAME = "heideOS";
...
/**
 * Open (or create) the heideOS IndexedDB database and ensure all required
